import { DispatchRemoteJobInputSchema, IssueHandshakeTicketInputSchema, ListRemoteAgentsInputSchema, PrepareRemoteWorldInputSchema, RegisterRemoteAgentInputSchema } from "../schemas/toolSchemas.js";
...
export function registerBridgeTools(server, services) {
    server.registerTool("qiyuan_register_remote_agent", {
    ...
    server.registerTool("qiyuan_list_remote_agents", {
    ...
    server.registerTool("qiyuan_issue_handshake_ticket", {
        ...
        const ticket = await services.handshakeService.issueTicket(params.remote_agent_id, params.requested_scopes, params.expires_in_minutes);
        return asToolResult({
    ...
    server.registerTool("qiyuan_prepare_remote_world", {
    ...
    server.registerTool("qiyuan_dispatch_remote_job", {
